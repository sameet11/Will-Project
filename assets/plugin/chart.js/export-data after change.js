...
(function (c) {
    "object" === typeof module && module.exports
        ...
        ? define("highcharts/modules/export-data", ["highcharts", "highcharts/modules/exporting"], function (e) {
              c(e);
              c.Highcharts = e;
              return c;
          })
    ...
    e(c, "mixins/ajax.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function (b, a) {
        ...
        b.getJSON = function (a, c) {
            b.ajax({ url: a, success: c, dataType: "json", headers: { "Content-Type": "text/plain" } });
        };
    });
    e(c, "mixins/download-url.js", [c["parts/Globals.js"]], function (b) {
        ...
        b.downloadURL = function (d, e) {
            ...
            if ("string" === typeof d || d instanceof String || !c.msSaveOrOpenBlob) {
                if (t || 2e6 < d.length) if (((d = b.dataURLtoBlob(d)), !d)) throw Error("Failed to convert to blob");
    ...
    e(c, "modules/export-data.src.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function (b, a) {
        function c(a, b) {
            ...
            try {
                ...
                if (!n) return f.createObjectURL(new d.Blob(["\ufeff" + a], { type: b }));
            } catch (H) {}
        }
        var e = a.defined,
            G = a.extend,
        ...
        b.Chart.prototype.getDataRows = function (a) {
            ...
            var w = u.categoryHeader,
                ...
                E = function (k, c, d) {
                    ...
                    return k ? (k instanceof b.Axis ? (k.options.title && k.options.title.text) || (k.dateTime ? m : w) : a ? { columnTitle: 1 < d ? c : k.name, topLevelColumnTitle: k.name } : k.name + (1 < d ? " (" + c + ")" : "")) : w;
                },
                F = function (a, c, d) {
                    var k = {},
                        h = {};
            ...
            this.series.forEach(function (k) {
                ...
                if (!1 !== k.options.includeInDataExport && !k.options.isInternal && !1 !== k.visible) {
                    ...
                    var u = { chart: k.chart, autoIncrement: k.autoIncrement, options: k.options, pointArrayMap: k.pointArrayMap };
            ...
            for (v = h.length; v--; ) {
                ...
                l.forEach(function (a) {
                    var b = a.name;
                    x && !e(b) && (x.dateTime ? (a.x instanceof Date && (a.x = a.x.getTime()), (b = d.dateFormat(f.dateFormat, a.x))) : (b = x.categories ? t(x.names[a.x], x.categories[a.x], a.x) : a.x));
                    a.splice(g, 0, b);
                });
            }
            p = p.concat(l);
        ...
        b.Chart.prototype.getCSV = function (a) {
            ...
            c.forEach(function (a, d) {
                for (var g, l = a.length; l--; ) (g = a[l]), "string" === typeof g && (g = '"' + g + '"'), "number" === typeof g && "." !== n && (g = g.toString().replace(".", n)), (a[l] = g);
                b += a.join(f);
                d < c.length - 1 && (b += e);
            });
            return b;
        ...
        b.Chart.prototype.getTable = function (a) {
            var b = '<table class="table table-borderless" id="highcharts-data-table-' + this.index + '">',
                c = this.options,
            ...
            var f = 0,
                ...
                n = function (a, b, c, g) {
                    var h = t(g, "");
                    b = "text" + (b ? " " + b : "");
                    "number" === typeof h ? ((h = h.toString()), "," === d && (h = h.replace(".", d)), (b = "number")) : g || (b = "empty");
                    return "<" + a + (c ? " " + c : "") + ' class="' + b + '">' + h + "</" + a + ">";
                };
            !1 !== c.exporting.tableCaption &&
                (b +=
                    '<caption class="highcharts-table-caption">' +
                    t(c.exporting.tableCaption, c.title.text ? c.title.text.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;") : "Chart") +
                    "</caption>");
                ...
                if (e) {
                    for (f += "<tr>"; h < d; ++h) {
                        ...
                        e === m
                            ? ++l
                            : l
                            ? ((f += n("th", "highcharts-table-topheading", 'scope="col" colspan="' + (l + 1) + '"', e)), (l = 0))
                            : (e === b[h] ? (c.exporting.useRowspanHeaders ? ((m = 2), delete b[h]) : ((m = 1), (b[h] = ""))) : (m = 1),
                              (f += n("th", "highcharts-table-topheading", 'scope="col"' + (1 < m ? ' valign="top" rowspan="' + m + '"' : ""), e)));
                    }
                    f += "</tr>";
                }
                if (b) {
                    f += "<tr>";
                    h = 0;
                    for (d = b.length; h < d; ++h) "undefined" !== typeof b[h] && (f += n("th", null, 'scope="col"', b[h]));
                    f += "</tr>";
                }
                return f + "</thead>";
        ...
        b.Chart.prototype.viewData = function () {
            this.dataTableDiv || ((this.dataTableDiv = C.createElement("div")), (this.dataTableDiv.className = "highcharts-data-table col-md-6 bg-white"), this.renderTo.parentNode.insertBefore(this.dataTableDiv, this.renderTo.nextSibling));
