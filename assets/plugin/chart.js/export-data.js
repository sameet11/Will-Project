...
(function (a) {
  ...
  k(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function (a) {
    var d = a.isSafari,
      f = a.win,
      p = f.document,
      l = f.URL || f.webkitURL || f,
      t = (a.dataURLtoBlob = function (a) {
        if (
          (a = a
            .replace(/filename=.*;/, "")
    ...
    a = a.downloadURL = function (a, l) {
      ...
      if ("string" === typeof a || a instanceof String || !g.msSaveOrOpenBlob) {
        ...
        if (
          ...
          if (((a = t(a) || ""), !a)) throw Error("Failed to convert to blob");
    ...
    function (a, d, f, p, l, t, g) {
      function k(a, B) {
        ...
        try {
          ...
          if (!c)
            return f.createObjectURL(new n.Blob(["\ufeff" + a], { type: B }));
        } catch (O) {}
      }
      var J = p.doc,
        c = p.seriesTypes,
      ...
      d.prototype.getDataRows = function (b) {
        ...
        var l = z.categoryHeader,
          N = z.categoryDatetimeHeader,
          u = function (q, e, m) {
        ...
        this.series.forEach(function (a) {
          ...
          if (
            ...
            for (l = 0; l < B; )
              (y = u(a, q[l], q.length)),
                n.push(y.columnTitle || y),
                b && p.push(y.topLevelColumnTitle || y),
                l++;
            var A = {
              chart: a.chart,
            ...
            a.options.data.forEach(function (b, u) {
              c && (C = I(a, q, u));
              var h = { series: A };
              a.pointClass.prototype.applyOptions.apply(h, [b]);
              b = h.x;
              var d = a.data[u] && a.data[u].name;
              l = 0;
              if (!e || "name" === a.exportKey || (!c && e && e.hasNames && d))
                b = d;
              g && (g[b] && (b += "|" + u), (g[b] = !0));
              r[b] || ((r[b] = []), (r[b].xValues = []));
              r[b].x = h.x;
              r[b].name = d;
              for (r[b].xValues[k] = h.x; l < B; )
                (u = q[l]),
                  (d = h[u]),
                  (r[b][x + l] = w(
                    C.categoryMap[u][d],
                    C.dateTimeValueAxisMap[u]
                      ? m.dateFormat(f.dateFormat, d)
                      : null,
                    d
                  )),
                  l++;
            ...
            k &&
              ...
              (k.dateTime
                ? (a.x instanceof Date && (a.x = a.x.getTime()),
                  (b = m.dateFormat(f.dateFormat, a.x)))
                : (b = k.categories
                    ? w(k.names[a.x], k.categories[a.x], a.x)
                    : a.x));
            a.splice(E, 0, b);
          });
        }
      ...
      d.prototype.getCSV = function (a) {
        var b = "",
          ...
          l = w(d.itemDelimiter, "," === f ? ";" : ","),
          g = d.lineDelimiter;
        c.forEach(function (a, d) {
          for (var m, r = a.length; r--; )
            (m = a[r]),
              "string" === typeof m && (m = '"' + m + '"'),
              "number" === typeof m &&
                "." !== f &&
      ...
      d.prototype.toggleDataTable = function (a) {
        (a = w(a, !this.isDataTableVisible)) &&
          !this.dataTableDiv &&
          ((this.dataTableDiv = J.createElement("div")),
        ...
        this.dataTableDiv &&
          ...
          a &&
            ...
            new f([this.getTableAST()]).addToDOM(this.dataTableDiv),
      ...
      v &&
        ...
        v.buttons &&
          v.buttons.contextButton.menuItems.push(
            "separator",
            "downloadCSV",
            "downloadXLS",
            "viewData"
