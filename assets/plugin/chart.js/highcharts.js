...
(function (X, L) {
  "object" === typeof module && module.exports
    ? ((L["default"] = L), (module.exports = X.document ? L(X) : L))
  ...
  L(a, "Core/Utilities.js", [a["Core/Globals.js"]], function (a) {
    ...
    function E(b, d) {
      var D = {};
      J(b, function (g, k) {
        if (G(b[k], !0) && !b.nodeType && d[k])
          (g = E(b[k], d[k])), Object.keys(g).length && (D[k] = g);
    ...
    return {
      ...
      normalizeTickInterval: function (b, d, g, k, r) {
        ...
        return (l = n(l * g, -Math.round(Math.log(0.001) / Math.LN10)));
      },
      objectEach: J,
      offset: function (b) {
          ...
          this.parsers = [
            {
              ...
              parse: function (q) {
                return [x(q[1]), x(q[2]), x(q[3]), parseFloat(q[4], 10)];
              },
            },
            {
              regex:
        ...
        u.prototype.init = function (a) {
          ...
          if (
            ...
            if (a && a.charAt && "#" === a.charAt()) {
              ...
              7 === h
                ? (B = [(a & 16711680) >> 16, (a & 65280) >> 8, a & 255, 1])
                : 4 === h &&
                  (B = [
                    ((a & 3840) >> 4) | ((a & 3840) >> 8),
                    ((a & 240) >> 4) | (a & 240),
        ...
        u.prototype.tweenTo = function (a, B) {
          ...
          h.length && q && q.length
            ? ((a = 1 !== h[3] || 1 !== q[3]),
              (B =
                (a ? "rgba(" : "rgb(") +
                Math.round(h[0] + (q[0] - h[0]) * (1 - B)) +
                "," +
                Math.round(h[1] + (q[1] - h[1]) * (1 - B)) +
                "," +
                Math.round(h[2] + (q[2] - h[2]) * (1 - B)) +
                (a ? "," + (h[3] + (q[3] - h[3]) * (1 - B)) : "") +
                ")"))
            : (B = a.input || "none");
          return B;
        ...
        w.prototype.dateFormat = function (c, l, e) {
          ...
          q(t, function (b, d) {
            for (; -1 !== c.indexOf("%" + d); )
              c = c.replace(
                "%" + d,
                "function" === typeof b ? b.call(n, l) : b
              );
          });
        ...
        w.prototype.getTimeTicks = function (c, l, t, h) {
          ...
          if (H(l)) {
            n.set(
              "Milliseconds",
              k,
              b >= e.second ? 0 : g * Math.floor(n.get("Milliseconds", k) / g)
            );
            b >= e.second &&
              n.set(
                "Seconds",
                k,
                b >= e.minute ? 0 : g * Math.floor(n.get("Seconds", k) / g)
              );
            b >= e.minute &&
              n.set(
                "Minutes",
                k,
                b >= e.hour ? 0 : g * Math.floor(n.get("Minutes", k) / g)
              );
            b >= e.hour &&
              n.set(
                "Hours",
                k,
                b >= e.day ? 0 : g * Math.floor(n.get("Hours", k) / g)
              );
            b >= e.day &&
              n.set(
                "Date",
                ...
                b >= e.month
                  ? 1
                  : Math.max(1, g * Math.floor(n.get("Date", k) / g))
              );
            if (b >= e.month) {
              n.set(
                "Month",
                k,
                b >= e.year ? 0 : g * Math.floor(n.get("Month", k) / g)
              );
            ...
            b === e.week &&
              ((F = n.get("Day", k)),
              n.set("Date", k, n.get("Date", k) - F + h + (F < h ? -7 : 0)));
            F = n.get("FullYear", k);
            h = n.get("Month", k);
            var D = n.get("Date", k),
              m = n.get("Hours", k);
            ...
            (!n.variableTimezone && n.useUTC) ||
              ...
              (r =
                t - l > 4 * e.month ||
                n.getTimezoneOffset(l) !== n.getTimezoneOffset(t));
            l = k.getTime();
            for (k = 1; l < t; )
              p.push(l),
                (l =
                  b === e.year
                    ...
                    : !r || (b !== e.day && b !== e.week)
                    ? r && b === e.hour && 1 < g
                      ? n.makeTime(F, h, D, m + k * g)
                      : l + b * g
                    : n.makeTime(F, h, D + k * g * (b === e.day ? 1 : 7))),
                k++;
            p.push(l);
            b <= e.hour &&
              1e4 > p.length &&
    ...
    function (a, u, E, H, x, y) {
      ...
      var h = {
        ...
        tooltip: {
          ...
          backgroundColor: E(H.neutralColor3).setOpacity(0.85).get(),
          borderWidth: 1,
          shadow: !0,
          style: {
            color: H.neutralColor80,
      ...
      return {
        ...
        setOptions: function (c) {
          ...
          if (c.time || c.global)
            a.time
              ? a.time.update(q(h.global, h.time, c.global, c.time))
              : (a.time = f);
          return h;
        },
      };
    ...
    function (a, u, E) {
      ...
      return (function () {
        ...
        a.prototype.run = function (q, h, f) {
          ...
          q !== h || this.elem["forceAnimate:" + this.prop]
        ...
        a.prototype.initPath = function (a, h, f) {
          ...
          function e(c, l) {
            for (; c.length < K; )
              if (
                ((l = c[Math.floor(c.length / n) - 1].slice()),
        ...
        animate: function (c, t, m) {
          ...
          f(t, function (f, p) {
            ...
            "d" === p && G(t.d)
              ...
              : c.attr
              ? (e = c.attr(p))
              : ((e = parseFloat(y(c, p)) || 0), "opacity" !== p && (n = "px"));
            l || (l = f);
            "string" === typeof l &&
              l.match("px") &&
              (l = l.replace(/px/g, ""));
    ...
    function (a, u, E, H, x, y) {
      ...
      a = (function () {
          ...
          0 !== z.duration
            ...
            : (this.attr(b, void 0, g),
              D(
                ...
                function (b, d) {
                  z.step &&
                    z.step.call(this, b, { prop: d, pos: 1, elem: this });
                },
                this
              ));
          return this;
        ...
        a.prototype.attr = function (b, d, g, k) {
          ...
          "string" === typeof b
            ? (I = (this[b + "Getter"] || this._defaultGetter).call(this, b, z))
            : (D(
                b,
                function (d, g) {
                  r = !1;
          ...
          if (a) {
            ...
            if (b)
              if (null === b.width || "auto" === b.width) delete this.textWidth;
                ...
                var I = (this.textWidth = C(b.width));
            this.styles = b;
        ...
        a.prototype.shadow = function (b, d, g) {
          ...
          if (!l) this.destroyShadows();
            ...
            for (r = 1; r <= l.width; r++) {
              ...
              g &&
                (n(f, "height", Math.max(n(f, "height") - C, 0)),
                (f.cutHeight = C));
              d
  ...
  L(
    ...
    function (a) {
      ...
      (function (v) {
        ...
        v.registerRendererType = function (x, y, G) {
          v.rendererTypes[x] = y;
    ...
    function (a, u) {
      ...
      return (function (h) {
        ...
        f.prototype.alignSetter = function (c) {
          ...
          c !== this.alignFactor &&
            ((this.alignFactor = c),
            this.bBox && y(this.xSetting) && this.attr({ x: this.xSetting }));
        };
  ...
  L(a, "Core/Renderer/SVG/Symbols.js", [a["Core/Utilities.js"]], function (a) {
    function v(a, q, h, f, c) {
      ...
      if (c) {
        ...
        var w = (c.end || 0) - 0.001;
        f = c.innerR;
        var n = G(c.open, 0.001 > Math.abs((c.end || 0) - t - 2 * Math.PI)),
          l = Math.cos(t),
          J = Math.sin(t),
          K = Math.cos(w),
          A = Math.sin(w);
        t = G(c.longArc, 0.001 > w - t - Math.PI ? 0 : 1);
        e.push(
          ["M", a + m * l, q + h * J],
          ["A", m, h, 0, t, G(c.clockwise, 1), a + m * K, q + h * A]
        );
        x(f) &&
          e.push(
            n ? ["M", a + f * K, q + f * A] : ["L", a + f * K, q + f * A],
            [
              "A",
              f,
              f,
          ...
          [].forEach.call(
            ...
            function (f, l) {
              f.nextSibling &&
                ...
                y(f, { dy: a.getLineHeight(f.nextSibling), x: e }));
            }
          );
          var h = this.width || 0;
          if (h) {
      ...
      E = (function () {
        ...
        z.prototype.init = function (b, d, g, a, r, c, z) {
          ...
          this.createElement("desc")
            .add()
            .element.appendChild(
              e.createTextNode("Created with Highcharts 9.1.2")
            );
          ...
          t &&
            ...
            d(),
            (this.unSubPixelFix = A(K, "resize", d)));
        };
        ...
        z.prototype.button = function (b, d, g, k, c, z, l, e, f, F) {
          ...
          if (!Q) {
            ...
            l = O(
              h,
              {
                ...
                style: { color: H.neutralColor100, fontWeight: "bold" },
              },
        ...
        z.prototype.symbol = function (g, a, c, z, l, F) {
          ...
          if (n) {
            ...
            w.imgwidth = v(J[N] && J[N].width, F && F.width);
        ...
        z.prototype.clipRect = function (b, d, g, a) {
          var k = Y() + "-",
    ...
    function (a, u, E) {
      ...
      return (function (a) {
        ...
        m.prototype.setSpanRotation = function (a, c, l) {
          var e = {},
            f =
              y && !/Edge/.test(B.navigator.userAgent)
                ? "-ms-transform"
                : G
                ? "-webkit-transform"
                : x
        ...
        f.prototype.html = function (c, e, f) {
          ...
          h.textSetter = function (c) {
            c !== this.textStr &&
              ...
              a.setElementHTML(this.element, q(c, "")),
              (this.textStr = c),
              (h.doTransform = !0));
          };
    ...
    return {
      registerEventOptions: function (a, u) {
        ...
        H(u.events, function (u, q) {
          E(u) &&
            a.eventOptions[q] !== u &&
            (E(a.eventOptions[q]) && x(a, q, a.eventOptions[q]),
            (a.eventOptions[q] = u),
            v(a, q, u));
        });
      },
    ...
    function (a, u, E) {
      ...
      u = (function () {
          ...
          c.shortenLabel = u
            ? function () {
                for (M = 0; M < u.length; M++)
                  if (
                    (q(v, { dateTimeLabelFormat: u[M] }),
                    D.attr({ text: W.call(v, v) }),
        ...
        m.prototype.getPosition = function (a, c, l, e) {
          ...
          a = {
            x: a
              ? y(f.translate(c + l, null, null, e) + f.transB)
              : f.left +
                f.offset +
                (f.opposite
                  ? ((e && n.oldChartWidth) || n.chartWidth) - f.right - f.left
                  : 0),
            y: a
              ? p - f.bottom + f.offset - (f.opposite ? f.height : 0)
              : y(p - f.translate(c + l, null, null, e) - f.transB),
          };
          a.y = x(a.y, -1e5, 1e5);
        ...
        m.prototype.moveLabel = function (a, c) {
          ...
          if (!p && (l.labelPos || f)) {
            ...
            h = h.horiz ? d.y : n ? h.width + h.left : 0;
        ...
        m.prototype.renderLabel = function (a, c, e, h) {
          ...
          d &&
            f(g) &&
            ((d.xy = a = this.getLabelPosition(g, a, d, n, k, l, h, b)),
    ...
    function (a, u, E, H, x, y, G, B, q) {
      ...
      a = (function () {
        ...
        a.prototype.init = function (b, a) {
          ...
          a = C(k.crosshair, W(b.options.tooltip.crosshairs)[c ? 0 : 1]);
        ...
        a.prototype.setOptions = function (b) {
          this.options = F(
            ...
            "yAxis" === this.coll && B.defaultYAxisOptions,
            [
                ...
                if (b.isXAxis) {
                  if (((c = d.xData), c.length)) {
                    ...
                    c.length &&
                      ...
                      (b.dataMax = Math.max(C(b.dataMax, z), z)));
                  }
                } else if (
                  ((d = d.applyExtremes()),
                  g(d.dataMin) &&
                  ...
                  g(d.dataMax) &&
                    ...
                    (b.dataMax = Math.max(C(b.dataMax, z), z))),
                  l(r) && (b.threshold = r),
                  !c.softThreshold || b.positiveValuesOnly)
                )
                  b.softThreshold = !1;
              }
            });
        ...
        a.prototype.translate = function (b, a, d, c, k, r) {
          ...
          a
            ? ((b = (b * f + I - z) / c + l), k && (b = e.lin2val(b)))
            : (k && (b = e.val2lin(b)),
              (b = g(l)
                ? f * (b - l) * c + I + f * z + (g(r) ? c * r : 0)
                : void 0));
          return b;
        };
        ...
        a.prototype.getPlotLinePath = function (b) {
          ...
          d(this, "getPlotLinePath", b, function (b) {
            ...
            g(p)
              ? c.horiz
                ? ((m = e), (q = h - c.bottom), (n = t = a(n, r, r + c.width)))
                : ((n = r), (t = F - c.right), (m = q = a(m, e, e + c.height)))
              : ((Z = !0), (M = !1));
            b.path =
              Z && !M
                ? null
        ...
        a.prototype.setTickInterval = function (b) {
          ...
          r &&
            (a.positiveValuesOnly &&
              ...
              A(10, 1, c),
            (a.min = n(r.log2lin(a.min), 16)),
            (a.max = n(r.log2lin(a.max), 16)));
          a.range &&
            l(a.max) &&
            ...
            "undefined" === typeof a.max
              ...
              : C(
                  ...
                  this.tickAmount
                    ...
                    : void 0,
                  z ? 1 : ((a.max - a.min) * F) / Math.max(a.len, F)
                );
          f &&
            !b &&
        ...
        a.prototype.setAxisSize = function () {
          var b = this.chart,
            ...
            c = (this.width = Math.round(
              O(C(a.width, b.plotWidth - d[3] + d[1]), b.plotWidth)
            )),
            k = (this.height = Math.round(
              O(C(a.height, b.plotHeight - d[0] + d[2]), b.plotHeight)
            )),
            e = (this.top = Math.round(
              O(C(a.top, b.plotTop + d[0]), b.plotHeight, b.plotTop)
            ));
          a = this.left = Math.round(
            O(C(a.left, b.plotLeft + d[3]), b.plotWidth, b.plotLeft)
          );
          this.bottom = b.chartHeight - k - e;
          this.right = b.chartWidth - c - a;
          this.len = Math.max(g ? c : k, 0);
          this.pos = g ? a : e;
        };
        ...
        a.prototype.getSlotWidth = function (b) {
          ...
          if (d && 2 > c.step)
            return c.rotation ? 0 : ((this.staggerLines || 1) * this.len) / k;
          if (!d) {
            b = c.style.width;
        ...
        a.prototype.renderUnsquish = function () {
          var b = this.chart,
            ...
            D = k.textOverflow,
            C = 0;
          r(c.rotation) || (h.rotation = c.rotation || 0);
              ...
              for (f = d.length; !e && f--; ) {
                ...
                if ((n = g[n].label))
                  n.styles && "ellipsis" === n.styles.textOverflow
                    ...
                    : n.textPxLength > l && n.css({ width: l + "px" }),
                    n.getBBox().height > this.len / d.length - (F.h - F.f) &&
          ...
          d.forEach(function (b) {
            ...
            a &&
              ...
              b.shortenLabel
                ...
                ? ((c.width = p + "px"),
                  D || (c.textOverflow = a.specificTextOverflow || M),
                  a.css(c))
                : a.styles &&
                  a.styles.width &&
                  !c.width &&
        ...
        a.prototype.addTitle = function (b) {
          ...
          this.axisTitle ||
            ...
            (this.axisTitle = a
              ...
              .attr({ zIndex: 7, rotation: c.rotation, align: e })
              .addClass("highcharts-axis-title")),
            k || this.axisTitle.css(F(c.style)),
        ...
        a.prototype.getOffset = function () {
          ...
          D || a.isLinked
            ? (e.forEach(function (b) {
              ...
              a.staggerLines && (A *= a.staggerLines),
              (a.labelOffset = A * (a.opposite ? -1 : 1)))
            : M(r, function (b, a) {
                b.destroy();
                delete r[a];
              });
          if (
            ...
            p.text &&
            !1 !== p.enabled &&
            (a.addTitle(O), O && !1 !== p.reserveSpace)
          ) {
          ...
          m[h] = Math.max(
            m[h],
            (a.axisTitleMargin || 0) + Z + t * a.offset,
            D,
        ...
        a.prototype.getLinePath = function (b) {
          ...
          return a.renderer.crispLine(
            [
              ...
              [
                "L",
                c ? a.chartWidth - this.right : k,
                c ? g : a.chartHeight - this.bottom,
              ],
            ],
            b
          );
        ...
        a.prototype.renderTick = function (b, a, d) {
          ...
          if (
            ...
            g[b] || (g[b] = new q(this, b)),
              d && g[b].isNew && g[b].render(a, !0, -1),
              g[b].render(a);
        };
        a.prototype.render = function () {
          ...
          if (b.hasData() || e) {
            ...
            r.length &&
              ...
              n &&
                (0 === b.min || b.single) &&
                (f[-1] || (f[-1] = new q(b, -1, null, !0)), f[-1].render(-1)));
            C &&
              r.forEach(function (d, g) {
                ...
                0 === g % 2 &&
                  d < b.max &&
                  A <= b.max + (a.polar ? -n : n) &&
                  (D[d] || (D[d] = new y.PlotLineOrBand(b)),
                  (O = d + n),
                  (D[d].options = {
          ...
          l &&
            t &&
            ((k = b.getTitlePosition()),
            g(k.y)
              ? (l[l.isNew ? "attr" : "animate"](k), (l.isNew = !1))
        ...
        a.prototype.destroy = function (b) {
          ...
          for (var k in a.plotLinesAndBandsGroups)
            a.plotLinesAndBandsGroups[k] =
              a.plotLinesAndBandsGroups[k].destroy();
          M(a, function (b, d) {
                ...
                (r
                  .attr({
                    stroke:
                      g.color ||
                      (c
                        ? u.parse(E.highlightColor20).setOpacity(0.25).get()
                        : E.neutralColor20),
        ...
        a.prototype.remove = function (b) {
          for (
            var a = this.chart, d = this.coll, g = this.series, c = g.length;
            c--;
        ...
        G = (function () {
          ...
          a.prototype.normalizeTimeTickInterval = function (a, h) {
            ...
            for (
              ...
              (c = y[h[0]]),
              (e = h[1]),
              f[t + 1] && a <= (c * e[e.length - 1] + y[f[t + 1][0]]) / 2);
              t++
            );
      ...
      var v = u.addEvent,
        ...
        G = (function () {
          ...
          a.prototype.getLogTickPositions = function (a, h, f, c) {
            ...
            if (0.5 <= a)
              (a = Math.round(a)), (w = e.getLinearTickPositions(a, h, f));
            else if (0.08 <= a) {
              var n = Math.floor(h),
                l,
                q = (m = void 0);
              ...
              (h = this.lin2log(h)),
                ...
                (a = x(a, void 0, H(a))),
                (w = e.getLinearTickPositions(a, h, f).map(this.log2lin)),
      ...
      var v = E.arrayMax,
        ...
        m = (function () {
          ...
          a.prototype.render = function () {
            ...
            l.chart.styledMode ||
              (F
                ? ((C.stroke = q || u.neutralColor40),
                  (C["stroke-width"] = t(w.width, 1)),
                  w.dashStyle && (C.dashstyle = w.dashStyle))
                : r &&
                  ((C.fill = q || u.highlightColor10),
                  w.borderWidth &&
                    ((C.stroke = w.borderColor),
                    (C["stroke-width"] = w.borderWidth))));
            B.zIndex = v;
            z += "-" + v;
            (m = l.plotLinesAndBandsGroups[z]) ||
              (l.plotLinesAndBandsGroups[z] = m =
                x
                  .g("plot-" + z)
                  .attr(B)
                  .add());
      ...
      a = (function () {
              ...
              if (this.split) this.renderSplit(a, k);
                ...
                (c = this.getLabel()),
                  ...
                  m ||
                    c.attr({
                      stroke:
                        d.borderColor || f.color || C.color || E.neutralColor60,
                    }),
                  this.updatePosition({
                    plotX: q,
                    plotY: w,
        ...
        a.prototype.renderSplit = function (a, k) {
          function b(b, a, g, c, k) {
            ...
            g
              ? ((a = T ? 0 : da),
                (b = B(b - c / 2, N.left, N.right - c - (d.outside ? R : 0))))
              : ((a -= V),
                (b = k ? b - c - x : b + x),
                (b = B(b, k ? b : N.left, N.right)));
            return { x: b, y: a };
          }
          var d = this,
            e = d.chart,
          ...
          var K = f.styledMode,
            ...
            N =
              d.outside && "number" !== typeof v
                ...
                : { left: J, right: J + h, top: A, bottom: A + p },
            P = d.getLabel(),
          ...
          a = a.slice(0, k.length + 1).reduce(function (a, g, c) {
            if (!1 !== g && "" !== g) {
              ...
              r ||
                ((r = { padding: y.padding, r: y.borderRadius }),
                K ||
                  ((r.fill = y.backgroundColor),
                  (r["stroke-width"] = y.borderWidth)),
                (r = U.label(
                  "",
                  0,
                  0,
                  y[h ? "headerShape" : "shape"] || "callout",
                  void 0,
                  void 0,
                  y.useHTML
                )
              ...
              K ||
                r
                  ...
                  .attr({
                    stroke:
                      y.borderColor || c.color || F.color || E.neutralColor80,
                  });
              f = f.tt = r;
              h = f.getBBox();
          ...
          !I &&
            a.some(function (b) {
              ...
              return a < N.left && a + b.boxWidth < N.right
                ? !0
                : a < R - N.left + b.boxWidth && N.right - a > a;
            }) &&
            (a = a.map(function (a) {
          ...
          a.forEach(function (b) {
            ...
            b = b.isHeader;
            b ||
              (d.outside && R + a < H && (H = R + a),
              !b && d.outside && H + g > ea && (ea = R + a));
          });
          a.forEach(function (b) {
            var a = b.x,
              g = b.anchorX,
          ...
          d.outside &&
            ...
            q &&
            ((f = P.getBBox()),
            q.setSize(f.width + f.x, f.height + f.y, !1),
            (a.style.left = H + "px"),
            (a.style.top = e + "px"));
        };
        ...
        a.prototype.updatePosition = function (a) {
          ...
          if (this.outside) {
            ...
            this.renderer.setSize(c.width + f, c.height + f, !1);
      ...
      a = (function () {
                ...
                d.styledMode ||
                  J.attr({
                    fill:
                      ...
                      v(E.highlightColor80).setOpacity(0.25).get(),
                  }));
              J &&
                c &&
                ((c = w - p),
                J.attr({ width: Math.abs(c), x: (0 < c ? 0 : c) + p }));
              J &&
                e &&
                ((c = A - m),
                J.attr({ height: Math.abs(c), y: (0 < c ? 0 : c) + m }));
        ...
        a.prototype.pinch = function (a) {
          ...
          "touchstart" === a.type
            ...
            : c.length &&
              (n ||
                (d.selectionMarker = n =
                  e({ destroy: B, touch: !0 }, b.plotBox)),
              d.pinchTranslate(c, f, C, n, t, h),
              (d.hasPinched = p),
              d.scaleGroups(C, t),
        ...
        a.prototype.runPointActions = function (d, c) {
          ...
          c = this.getHoverData(
            ...
            b.series,
            (!d || "touchmove" !== d.type) &&
              (!!c || (k && k.directTouch && this.isDirectTouch)),
            e,
            d
          );
          f = c.hoverPoint;
          ...
          if (f && (f !== b.hoverPoint || (g && g.isHidden))) {
            ...
            c &&
              ...
              !g.isHidden &&
              ((f = g.getAnchor([{}], d)),
              b.isInsidePlot(f[0], f[1], { visiblePlotOnly: !0 }) &&
                g.updatePosition({ plotX: f[0], plotY: f[1] }));
          this.unDocMouseMove ||
            ((this.unDocMouseMove = q(
        ...
        a.prototype.setDOMEvents = function () {
          ...
          this.eventsToUnbind.push(
            q(c, "mouseenter", this.onContainerMouseEnter.bind(this))
          );
          this.eventsToUnbind.push(
            q(c, "mouseleave", this.onContainerMouseLeave.bind(this))
          );
          a.unbindDocumentMouseUp ||
            (a.unbindDocumentMouseUp = q(
              b,
              "mouseup",
    ...
    function (a, u, E) {
      ...
      return (function (e) {
        ...
        l.prototype.batchMSEvents = function (a) {
          ...
          a(B, w ? "pointerup" : "MSPointerUp", this.onDocumentPointerUp);
        };
              ...
              if (b && r) {
                ...
                if (A)
                  if (n) n[d ? "animate" : "attr"]({ x: A.x, y: A.y });
                    ...
                    g &&
                      ((c.stateMarkerGraphic = n =
                        w.renderer
                          .symbol(g, A.x, A.y, A.width, A.height)
                          .add(c.markerGroup)),
                      (n.currentSymbol = g));
                !w.styledMode && n && n.attr(c.pointAttribs(this, b));
              }
              n &&
                (n[b && this.isInside ? "show" : "hide"](),
                (n.element.point = this));
            }
            f = f.halo;
            A = ((n = this.graphic || n) && n.visibility) || "inherit";
            f && f.size && n && "hidden" !== A && !this.isCluster
              ? (v || (c.halo = v = w.renderer.path().add(n.parentGroup)),
      ...
      var d = (function () {
        ...
        a.prototype.renderItem = function (a) {
          ...
          t ||
            ...
            (a.legendItem = t =
              d.text("", m ? e + f : -f, this.baseline || 0, A)),
            ...
            this.setItemEvents && this.setItemEvents(a, t, A));
          v &&
            !a.checkbox &&
        ...
        a.prototype.handleOverflow = function (a) {
          ...
          a && 0 < f && a > f && !1 !== p.enabled
            ? ((this.clipHeight = h =
              ...
              I(h),
              w ||
                ((this.nav = w = c.g().attr({ zIndex: 1 }).add(this.group)),
                (this.up = c.symbol("triangle", 0, 0, n, n).add(w)),
                ...
                this.pager.add(w),
                (this.down = c.symbol("triangle-down", 0, 0, n, n).add(w)),
    ...
    function (a, u, E, H, x, y, G, B, q, h, f, c, e, t, m) {
      ...
      a = (function () {
        ...
        a.prototype.isInsidePlot = function (a, b, d) {
          ...
          !d.ignoreY &&
            a.isInsidePlot &&
            ((c = (I && (c ? I.xAxis : I.yAxis)) || { pos: f, len: Infinity }),
        ...
        a.prototype.temporaryDisplay = function (a) {
          ...
          if (a)
            for (; b && b.style; )
              b.hcOrigStyle && (O(b, b.hcOrigStyle), delete b.hcOrigStyle),
                b.hcOrigDetached &&
            ...
            for (; b && b.style; ) {
              ...
              if ("none" === aa(b, "display", !1) || b.hcOricDetached)
                (b.hcOrigStyle = {
        ...
        a.prototype.drawChartBox = function () {
          ...
          if (e) var N = (A = P.strokeWidth());
            ...
            f = { fill: f || "none" };
            if (N || P["stroke-width"])
              (f.stroke = a.borderColor), (f["stroke-width"] = N);
          ...
          w[v](p);
          e ||
            (w.attr({ fill: k || "none" }).shadow(a.plotShadow),
            l &&
              (g
                ? (l !== g.attr("href") && g.attr("href", l), g.animate(p))
                : (this.plotBGImage = b.image(l, h, I, r, m).add())));
          t
        ...
        a.prototype.update = function (a, b, d, c) {
          ...
          m || (I(t) && t !== f.chartWidth) || (I(p) && p !== f.chartHeight)
            ? f.setSize(t, p, c)
            : R(b, !0) && f.redraw(c);
      ...
      return (a.LegendSymbolMixin = {
        ...
        drawLineMarker: function (a) {
          ...
          x &&
            !1 !== x.enabled &&
            B &&
            ((u = Math.min(H(x.radius, h), h)),
            0 === this.symbol.indexOf("url") &&
              ((x = v(x, { width: q, height: q })), (u = 0)),
            (this.legendSymbol = x =
              f
                .symbol(this.symbol, B / 2 - u, a - u, 2 * u, 2 * u, x)
                .addClass("highcharts-point")
                .add(c)),
            (x.isMarker = !0));
        },
    ...
    function (a, u, E, H, x, y, G, B, q, h) {
      ...
      a = (function () {
        ...
        a.prototype.setOptions = function (a) {
          ...
          g = Y(k, e.series, g.plotOptions && g.plotOptions[this.type], a);
          this.tooltipOptions = Y(
            n.tooltip,
            n.plotOptions.series && n.plotOptions.series.tooltip,
            n.plotOptions[this.type].tooltip,
          ...
          if (!C) {
            ...
            if (m && k > m)
              if (((m = e.getFirstValidPoint(a)), S(m)))
                for (d = 0; d < k; d++)
                  (I[d] = this.autoIncrement()), (n[d] = a[d]);
              else if (O(m))
                if (q)
                  for (d = 0; d < k; d++)
                    (c = a[d]), (I[d] = c[0]), (n[d] = c.slice(1, q + 1));
                else
                  for (
                    w &&
                      ((A = w.indexOf("x")),
          ...
          for (p = 0; p < k; p++) {
            ...
            if (h) {
              ...
              n.dataGroup.options &&
                ...
                F(n, n.dataGroup.options),
                delete n.dataLabels);
            } else
              (n = d[t]) ||
                "undefined" === typeof b[t] ||
                (d[t] = n = new f().init(this, b[t], e[p]));
        ...
        a.prototype.getExtremes = function (a, b) {
          ...
          for (r = 0; r < c; r++) {
            ...
            m =
              ...
              ((e[r + h] || m) >= k && (e[r - h] || m) <= l);
            if (n && m)
              if ((n = t.length)) for (; n--; ) S(t[n]) && (g[f++] = t[n]);
              else g[f++] = t;
          }
          ...
          for (m = 0; m < h; m++) {
            var u = l[m],
              ...
              B =
                ...
                f.stacking &&
                f.stacking.stacks[
                  (this.negStacks && D < (w ? 0 : q) ? "-" : "") + this.stackKey
                ],
              x = void 0,
              K = void 0;
            if (
            ...
            O(K) &&
              ((J = K[0]),
              (D = K[1]),
              J === w && y.key === B[F].base && (J = z(S(q) && q, f.min)),
        ...
        a.prototype.pointAttribs = function (a, b) {
          ...
          c = z(
            b.lineWidth,
            d.lineWidth,
            c + z(b.lineWidthPlus, d.lineWidthPlus, 0)
          );
        ...
        a.prototype.applyZones = function () {
          ...
          if (c.length && (l || h) && m && "undefined" !== typeof m.min) {
            ...
            c.forEach(function (c, I) {
              ...
              w = Math.max(e, g);
              m.isXAxis
                ? ((k = { x: t ? w : q, y: 0, width: n, height: r }),
                  F || (k.x = b.plotHeight - k.x))
                : ((k = { x: 0, y: t ? w : q, width: r, height: n }),
                  F && (k.y = b.plotWidth - k.y));
              t &&
                d.isVML &&
                (k = m.isXAxis
                  ? { x: 0, y: C ? q : w, height: k.width, width: b.chartWidth }
                  : {
              ...
              f[I] ? f[I].animate(k) : (f[I] = d.clipRect(k));
              v = a["zone-area-" + I];
              u = a["zone-graph-" + I];
              l && u && u.clip(f[I]);
              h && v && v.clip(f[I]);
        ...
        a.prototype.render = function () {
          ...
          l ||
            (e && c.defer && (e += c.defer),
            (a.animationTimeout = aa(function () {
              a.afterAnimate();
            }, e || 0)));
          a.isDirty = !1;
          a.hasRendered = !0;
        ...
        a.prototype.redraw = function () {
          ...
          d &&
            ...
            d.animate({
              translateX: z(c && c.left, a.plotLeft),
        ...
        a.prototype.searchKDTree = function (a, d, c) {
          function e(a, d, c, h) {
            ...
            n = (t || 0) + (n || 0);
            p.dist = b(n) ? Math.sqrt(n) : Number.MAX_VALUE;
        ...
        a.defaultOptions = {
          ...
          marker: {
            ...
            states: {
              ...
              select: {
                fillColor: y.neutralColor20,
                lineColor: y.neutralColor100,
                lineWidth: 2,
              },
            },
          },
        ...
        q = (function () {
          ...
          a.prototype.resetStacks = function () {
            ...
            this.axis.isXAxis ||
              B(c, function (c) {
                B(c, function (e, f) {
                  G(e.touched) && e.touched < a.stacksTouched
        ...
        w = (function () {
          ...
          a.prototype.setOffset = function (a, c, f, n, p) {
            var d = this.axis,
              k = d.chart;
            n = d.translate(
              d.stacking.usePercentage ? 100 : n ? n : this.total,
              0,
              0,
              0,
              1
            ...
            c &&
              ...
              (b =
                "left" === b
                  ...
                  ? f
                    ...
                    : -n
                  : p.width / 2),
              (f = k.inverted ? p.height / 2 : f ? -n : p.height),
              ...
              m(!a && this.options.crop, !0) &&
                ((k =
                  e(c.x) &&
                  e(c.y) &&
                  k.isInsidePlot(c.x - n + c.width, c.y) &&
                  k.isInsidePlot(c.x + n, c.y)) ||
                  c.hide()));
          };
      ...
      x.prototype.setStackedPoints = function (a) {
        ...
        if (
          ...
          for (x = 0; x < p; x++) {
            ...
            var H = G.key;
            var z = (C = r && E < (b ? 0 : k)) ? g : a;
            u[z] || (u[z] = {});
            u[z][y] ||
              (B[z] && B[z][y]
                ? ((u[z][y] = B[z][y]), (u[z][y].total = null))
                : (u[z][y] = new w(v, v.options.stackLabels, C, y, d)));
            z = u[z][y];
            null !== E
              ? ((z.points[H] = z.points[this.index] = [m(z.cumulative, b)]),
                h(z.cumulative) || (z.base = H),
                (z.touched = v.stacking.stacksTouched),
                0 < G.index &&
                  !1 === this.singleStacks &&
                  (z.points[H][0] = z.points[this.index + "," + y + ",0"][0]))
              : (z.points[H] = z.points[this.index] = null);
            "percent" === e
              ? ((C = C ? a : g),
                r && u[C] && u[C][y]
                  ? ((C = u[C][y]),
                    (z.total = C.total =
                      Math.max(C.total, z.total) + Math.abs(E) || 0))
                  : (z.total = q(z.total + (Math.abs(E) || 0))))
              : "group" === e
              ? (c(E) && (E = E[0]),
                null !== E && (z.total = (z.total || 0) + 1))
              : (z.total = q(z.total + (E || 0)));
            z.cumulative =
              "group" === e
                ? (z.total || 1) - 1
                : m(z.cumulative, b) + (E || 0);
            null !== E &&
              (z.points[H].push(z.cumulative),
              (t[x] = z.cumulative),
              (z.hasValidPoints = !0));
          }
    ...
    function (a, u, E, H) {
      ...
      H = (function (B) {
        ...
        q.prototype.getGraphPath = function (a, f, c) {
          ...
          (m = { right: 1, center: 2 }[m] || (m && 3)) && q && (m = 4 - m);
        ...
        c.prototype.drawGraph = function () {
          ...
          q.forEach(function (a) {
            ...
            c.chart.styledMode ||
              (q.fill = h(
                a[3],
                y(a[2]).setOpacity(h(m.fillOpacity, 0.75)).get()
              ));
            t[n](q);
            t.startX = f.xMap;
        ...
        c.prototype.getGraphPath = function (a) {
          ...
          for (l = 0; l < a.length; l++) {
            ...
            if (!g || e)
              e || b(l, l - 1, "left"),
                (g && !f && e) ||
                  (v.push(a[l]), q.push({ x: l, plotX: r, plotY: F })),
                e || b(l, l + 1, "right");
          }
          l = c.call(this, v, !0, !0);
          q.reversed = !0;
    ...
    function (a, u) {
      ...
      u = (function (a) {
        ...
        u.prototype.getPointSpline = function (a, h, f) {
          ...
          h = [
            "C",
            y(t.rightContX, t.plotX, 0),
            y(t.rightContY, t.plotY, 0),
            y(n, c, 0),
            y(l, e, 0),
            c,
            e,
      ...
      B = (function (a) {
        ...
        d.prototype.getColumnMetrics = function () {
          ...
          d = Math.min(
            ...
            A(d.pointWidth, t * (1 - 2 * d.pointPadding))
          );
          a.columnMetrics = {
            width: d,
            offset:
      ...
      h = (function (a) {
        ...
        h.prototype.translate = function (a) {
          ...
          for (v = 0; v < u; v++) {
            ...
            w.tooltipPos = [a[0] + 0.7 * y, a[1] + 0.7 * B];
  ...
  L(
    ...
    function (a, u, E, H, x, y, G) {
            ...
            a.targets.some(function () {
              ...
              if (
                ...
                return (
                  ...
                  h.reducedLen > 0.1 * c && E.distribute(h, c, e),
                  !0
                );
              b += h[d].size;
              d++;
      ...
      x.prototype.drawDataLabels = function () {
        ...
        if (m(h) || h.enabled || e._hasPointLabels) {
          ...
          !A &&
            (A = e.dataLabelsGroup) &&
            (e.visible && B.show(!0),
            A[f.animation ? "animate" : "attr"]({ opacity: 1 }, C));
          u.forEach(function (g) {
            ...
            x.forEach(function (d, k) {
              ...
              if (h) {
                ...
                var w = d.rotation;
                b.styledMode ||
                  ((u.color = l(d.color, u.color, e.color, H.neutralColor100)),
                  "contrast" === u.color
                    ? ((g.contrastColor = y.getContrast(g.color || e.color)),
                      (u.color =
      ...
      x.prototype.alignDataLabel = function (a, c, f, b, g) {
        var d = this,
          ...
          x =
            ...
            (a.series.forceDL ||
              (m && !w) ||
              u ||
              (l(f.inside, !!this.options.stacking) &&
                b &&
        ...
        if (x) {
          var y = k.renderer.fontMetrics(
            k.styledMode ? void 0 : f.style.fontSize,
            c
          ).b;
          b = e(
            {
          ...
          t
            ? ((w = !1),
              (p = k.renderer.rotCorr(y, t)),
              (p = {
                x: b.x + (f.x || 0) + b.width / 2 + p.x,
                y:
                  b.y +
                  (f.y || 0) +
                  { top: 0, middle: 0.5, bottom: 1 }[f.verticalAlign] *
                    b.height,
              }),
              A(p),
              c[g ? "attr" : "animate"](p).attr({ align: v }),
              (A = (t + 720) % 360),
              (A = 180 < A && 360 > A),
              "left" === v
                ? (p.y -= A ? q.height : 0)
                ...
                : "right" === v &&
                  ((p.x -= q.width), (p.y -= A ? 0 : q.height)),
              (c.placed = !0),
              (c.alignAttr = p))
            : (A(b), c.align(f, void 0, b), (p = c.alignAttr));
          w && 0 <= b.height
            ? this.justifyDataLabel(c, f, p, q, b, g)
            : l(f.crop, !0) &&
              (x =
                k.isInsidePlot(p.x, p.y, { paneCoordinates: !0, series: d }) &&
      ...
      y.pie &&
              ...
              if (h) {
                ...
                if (0 < a.maxLabelDistance) {
                  ...
                  d.forEach(function (a) {
                    0 < a.labelDistance &&
                      a.dataLabel &&
                      ((a.top = Math.max(0, G - B - a.labelDistance)),
                      (a.bottom = Math.min(
                        G + B + a.labelDistance,
                        b.plotHeight
                      )),
                ...
                for (U = 0; U < h; U++) {
                  ...
                  z._attr = { visibility: P, align: K.alignment };
                  ...
                  l(f.crop, !0) &&
                    ...
                    I - J < m && 1 === g
                      ...
                      : I + J > q - m &&
                        0 === g &&
                        ((n = Math.round(I + J - q + m)),
                        (T[1] = Math.max(n, T[1]))),
                    0 > N - L / 2
                      ? (T[0] = Math.max(Math.round(-N + L / 2), T[0]))
                      : N + L / 2 > t &&
                        (T[2] = Math.max(Math.round(N + L / 2 - t), T[2])),
                    (z.sideOverflow = n));
                }
              }
            }),
                    ...
                    (c.connector = A =
                      ...
                      b.styledMode ||
                        A.attr({
                          "stroke-width": n,
                          stroke:
                            V.connectorColor || c.color || H.neutralColor60,
                        });
                  A[d ? "attr" : "animate"]({ d: c.getConnectorPath() });
                  A.attr("visibility", P);
                } else A && (c.connector = A.destroy());
              }
            }));
        }),
        ...
        (y.pie.prototype.alignDataLabel = a),
      ...
      y.column &&
        (y.column.prototype.alignDataLabel = function (a, c, e, b, f) {
