...
(function (c) {
  ...
  n(
    ...
    function (c, n, k, z, r, H, I, J, B, t, C, w, K, D, p) {
      var E = c.animObject,
        L = H.format,
        M = I.noop;
      c = J.defaultOptions;
      ...
      k.prototype.addSingleSeriesAsDrilldown = function (a, b) {
        ...
        d.chart.series.forEach(function (a) {
          a.xAxis !== g ||
            a.isDrilling ||
            ((a.options._ddSeriesId = a.options._ddSeriesId || F++),
            (a.options._colorIndex = a.userOptions._colorIndex),
            (a.options._levelNumber = a.options._levelNumber || y),
            h
              ? ((e = h.levelSeries), (c = h.levelSeriesOptions))
              : (e.push(a),
                (a.purgedOptions = u(
                  {
        ...
        d.type === b.type &&
          ((b.animate = b.animateDrilldown || M), (b.options.animation = !0));
      };
      ...
      k.prototype.getDrilldownBackText = function () {
        ...
        if (a && 0 < a.length)
          return (
            ...
            L(this.options.lang.drillUpText, a)
          );
      };
      ...
      r.prototype.animateDrilldown = function (a) {
        var b = this,
          ...
          c = d.drilldownLevels,
          f,
          e = E(d.options.drilldown.animation),
          k = this.xAxis,
          h = d.styledMode;
        a ||
          ...
          this.points.forEach(function (a) {
            ...
            a.graphic &&
              a.graphic
                .attr(f)
                .animate(q(a.shapeArgs, { fill: a.color || b.color }), e);
            a.dataLabel && a.dataLabel.fadeIn(e);
          }),
          delete this.animate);
      };
      r.prototype.animateDrillupFrom = function (a) {
        var b = E(this.chart.options.drilldown.animation),
          d = this.group,
            ...
            if (this.center) {
              ...
              a ||
                (this.points.forEach(function (a, g) {
                  ...
                  if (a.graphic)
                    a.graphic
                      .attr(u(c, { start: f + g * e, end: f + (g + 1) * e }))
                      [d ? "animate" : "attr"](h, d);
                }),
                delete this.animate);
            }
      ...
      t.prototype.doDrilldown = function () {
        this.runDrilldown();
      };
      t.prototype.runDrilldown = function (a, b, d) {
      ...
      D.prototype.drillable = function () {
        ...
        c &&
          (b && f && f.length
            ? ((b.drillable = !0),
              b.basicStyles || e || (b.basicStyles = u(b.styles)),
              b.addClass("highcharts-drilldown-axis-label"),
              b.removeOnDrillableClick && N(b.element, "click"),
      ...
      m(t, "afterInit", function () {
        this.drilldown &&
          !this.unbindDrilldownClick &&
          (this.unbindDrilldownClick = m(this, "click", G));
        return this;
      });
      m(t, "update", function (a) {
        a = a.options || {};
