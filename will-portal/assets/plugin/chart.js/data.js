    ...
    function (b, p) {
      ...
      b.ajax = function (b) {
        ...
        c.headers["Content-Type"] ||
          r.setRequestHeader("Content-Type", b[c.dataType] || b.text);
      ...
      return { ajax: b.ajax, getJSON: b.getJSON };
    }
  );
  p(
    b,
    ...
    function (b, p, u, G, H, c) {
      ...
      c = (function () {
        ...
        b.prototype.init = function (a, d, g) {
          ...
          this.hasURLOption(a) &&
            (clearTimeout(this.liveDataTimeout), (k = !1));
            ...
            function h() {
              f > n || n > O
                ...
                : (!isNaN(parseFloat(m)) && isFinite(m)
                    ? ((m = parseFloat(m)), k("number"))
                    : isNaN(Date.parse(m))
                    ? k("string")
                    : ((m = m.replace(/\//g, "-")), k("date")),
                  C.length < t + 1 && C.push([]),
                  g || (C[t][d] = m),
                  (m = ""),
                  ++t,
              ...
              for (f = 0; f < h.length; f++)
                !1 !== h[f]
                  ? 12 < m[f] &&
                    ...
                    "YYYY" !== e[f] &&
                    (e[f] = "YY")
                  : 12 < m[f] && "mm" === e[f] && (e[f] = "dd");
              3 === e.length && "dd" === e[1] && "dd" === e[2] && (e[2] = "YY");
              a = e.join("/");
              return (b.dateFormats || k.dateFormats)[a]
                ? a
                : (K("deduceDateFailed"), "YYYY/mm/dd");
            }
            return "YYYY/mm/dd";
          }
          var k = this,
        ...
        b.prototype.parseTable = function () {
          ...
          d &&
            ("string" === typeof d && (d = x.getElementById(d)),
              ...
              d >= e &&
                ...
                [].forEach.call(a.children, function (a, b) {
                  ...
                  if (
                    ...
                    for (
                      g[b - c] || (g[b - c] = []),
                        g[b - c][d - e] = a.innerHTML;
                      d - e >= f && void 0 === k[d - e - f];
          ...
          function a(k) {
            function f(f, h, m) {
              function n() {
                c &&
                  g.liveDataURL === f &&
                  (d.liveDataTimeout = setTimeout(a, l));
              }
              if (!f || !/^(http|\/|\.\/|\.\.\/)/.test(f))
                return f && e.error && e.error("Invalid URL"), !1;
            ...
            f(
              ...
              f(n.rowsURL, function (a) {
                g.update({ data: { rows: a } });
              }) ||
              f(n.columnsURL, function (a) {
                g.update({ data: { columns: a } });
              });
          }
          var d = this,
            g = this.chart,
            ...
            a(function (a) {
              ...
              for (c = 0; c < g; c++) {
                ...
                if (q >= f && q <= p && k >= l && k <= n) {
                  ...
                  t.numericValue
                    ? (h =
                        0 <= t.$t.indexOf("/") || 0 <= t.$t.indexOf("-")
                          ? t.$t
                          : 0 < t.$t.indexOf("%")
                          ? 100 * parseFloat(t.numericValue)
                          : parseFloat(t.numericValue))
                    : t.$t && t.$t.length && (h = t.$t);
                  e[q - f][k - l] = h;
                }
              }
        ...
        b.prototype.parseColumn = function (a, d) {
          var g = this.rawColumns,
            ...
            p = this.chartOptions,
            q,
            r = (this.options.columnTypes || [])[d];
          p =
            l &&
            ((p && p.xAxis && "category" === N(p.xAxis)[0].type) ||
              "string" === r);
          for (g[d] || (g[d] = []); b--; ) {
            var m = f[b] || a[b];
            var y = this.trim(m);
            ...
            p || (0 === b && c)
              ...
              ? ((a[b] = w),
                31536e6 < w && "float" !== r
                  ? (a.isDatetime = !0)
                  : (a.isNumeric = !0),
                "undefined" !== typeof a[b + 1] && (q = w > a[b + 1]))
              : (y && y.length && (n = this.parseDate(m)),
                l && E(n) && "float" !== r
                  ? ((f[b] = m),
                    (a[b] = n),
                    (a.isDatetime = !0),
                    "undefined" !== typeof a[b + 1] &&
                      ((m = n > a[b + 1]),
                      m !== q &&
                        "undefined" !== typeof q &&
          ...
          if (l && q && this.options.sort)
            for (d = 0; d < e.length; d++)
              e[d].reverse(), c && e[d].unshift(e[d].pop());
        };
          ...
          if (d) var h = d(a);
            ...
            c ||
              ...
              "object" === typeof c && null !== c && c.getTime
                ? (h = c.getTime() - 6e4 * c.getTimezoneOffset())
                : E(c) && (h = c - 6e4 * new Date(c).getTimezoneOffset()));
          }
          return h;
        };
        ...
        b.prototype.complete = function () {
          ...
          if (c.complete || c.afterComplete) {
            ...
            0 < h.length &&
              0 < h[0].readers.length &&
              ((f = a[h[0].readers[0].columnIndex]),
              "undefined" !== typeof f &&
                (f.isDatetime
                  ? (b = "datetime")
                  : f.isNumeric || (b = "category")));
            if ("category" === b)
              for (e = 0; e < h.length; e++)
                for (f = h[e], n = 0; n < f.readers.length; n++)
                  "x" === f.readers[n].configName &&
                    (f.readers[n].configName = "name");
            for (e = 0; e < h.length; e++) {
              f = h[e];
              n = [];
        ...
        b.prototype.read = function (a, b) {
          ...
          this.readers.forEach(function (c) {
            ...
            d
              ...
              ? G.prototype.setNestedProperty(e, g, c.configName)
              : (e[c.configName] = g);
          });
